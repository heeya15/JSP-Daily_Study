...
<html>
<head>
<title>🐶MISSING PET|관리자(댓글)</title>
<meta charset="utf-8" />
      ...
      <form method="POST">
       <table style="width: auto;">
            ...
            <tbody style="text-align: center; font-size: 15px">
              <c:forEach items="${sessionScope.Allreplylist}" var="item" varStatus="status">
              <tr>
		 ...
		 <ul class="pagination">
      	<c:forEach items="${sessionScope.Allreplypaging}" var="item" varStatus="i">
