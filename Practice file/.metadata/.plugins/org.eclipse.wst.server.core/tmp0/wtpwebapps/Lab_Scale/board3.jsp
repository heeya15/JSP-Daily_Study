  ...
  <main id="main" class="col-md-9 float-left col pl-md-5 pt-3 main">
    <div align="center">
      <div class="page-header mt-3">
        <h2><a href="/Lab-scale/board.do">게시판</a></h2>
      </div>
      ...
      <c:forEach items="${sessionScope.paginglist}" var="item" varStatus="i">
		...
		<c:forEach var="j" begin="${item.startpage}" end="${item.endpage}" step="1">
			...
			<c:otherwise>
			<li><a class="page-link mobile" href="/Lab-scale/board.do?page=${j}&opt="${param.opt}">${j}</a></li>
			</c:otherwise>
		</c:choose>
		</c:forEach>
          </c:forEach>
      </ul>
      <div id="searchForm" style="width: 1200px; margin: 1 auto;">
        <form>
          <div class="grid_item first" style="width:180px; float:left; margin-right:10">
          ...
          <div class="grid_item two" style="width:600px; float:left">
      <input type="text" size="10" style="background-color: white; color: black; " name="condition"/>
          </div>
          
          <div class="grid_item third" style="width:160px; float:left">
